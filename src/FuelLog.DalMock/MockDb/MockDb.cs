  ...
  public class MockDb {
    ...
    static MockDb() {
      Cars = new List<CarData>{
                ...
                new CarData{ Id = 1, Make = "Volvo", Model = "XC60", LicensePlate = "MTS418", Note = "My current car in Finland", DistanceUnit = "km", VolumeUnit = "l", ConsumptionUnit = "l/100km", TotalFillups = 48, TotalDistance = 78965, AverageConsumption = 8.45M },
