  ...
  public class MockDb {
    ...
    static MockDb()
    {
      Cars = new List<CarData> {
        new CarData{ Id = 0, Make = "BMW", Model = "320d", LicensePlate = "OUS318", Note = "My first BMW", DistanceUnit = 0, VolumeUnit = 3, ConsumptionUnit = 9 }, // , TotalFillups = 64, TotalDistance = 55221AverageConsumption = 6.75M },
        new CarData{ Id = 1, Make = "Volvo", Model = "XC60", LicensePlate = "MTZ418", Note = "My current car in Finland", DistanceUnit = 1, VolumeUnit = 5, ConsumptionUnit = 12 }, // , TotalFillups = 48, TotalDistance = 78965AverageConsumption = 8.45M },
        new CarData{ Id = 2, Make = "Volvo", Model = "XC90", LicensePlate = "BKX594", Note = "My rental Volvo in Gothenburg", DistanceUnit = 0, VolumeUnit = 3, ConsumptionUnit = 12 }, // , TotalFillups = 64, TotalDistance = 8922AverageConsumption = 7.75M },
      };
      ...
      Units = new List<UnitData> {
        ...
        new UnitData{ Id = 3, Name = "Litres (l)", ShortName = "l", Category = 1 },
        new UnitData{ Id = 4, Name = "Gallons US (gal)", ShortName = "gal", Category = 1 },
        new UnitData{ Id = 5, Name = "Gallons Imp (gal)", ShortName = "gal", Category = 1 },
        new UnitData{ Id = 6, Name = "Electric (kWh)", ShortName = "kWh", Category = 1 },
        new UnitData{ Id = 7, Name = "CNG (kg)", ShortName = "kg", Category = 1 },
        new UnitData{ Id = 8, Name = "CNG (gge)", ShortName = "gge", Category = 1 },
        new UnitData{ Id = 9, Name = "l/100km", Category = 2 },
        new UnitData{ Id = 10, Name = "mpg (us)", Category = 2 },
        new UnitData{ Id = 11, Name = "mpg (uk)", Category = 2 },
        new UnitData{ Id = 12, Name = "km/l", Category = 2 },
        new UnitData{ Id = 13, Name = "l/km", Category = 2 },
        new UnitData{ Id = 14, Name = "l/mi", Category = 2 },
        new UnitData{ Id = 15, Name = "l/100mi", Category = 2 },
        new UnitData{ Id = 16, Name = "mi/l", Category = 2 },
        new UnitData{ Id = 17, Name = "gal(us)/km", Category = 2 },
        new UnitData{ Id = 18, Name = "gal(us)/100km", Category = 2 },
        new UnitData{ Id = 19, Name = "gal(us)/mi", Category = 2 },
        new UnitData{ Id = 20, Name = "gal(us)/100mi", Category = 2 },
        new UnitData{ Id = 21, Name = "km/gal(us)", Category = 2 },
        new UnitData{ Id = 22, Name = "gal(uk/km)", Category = 2 },
        new UnitData{ Id = 23, Name = "gal(uk)/100km", Category = 2 },
        new UnitData{ Id = 24, Name = "gal(uk)/mi", Category = 2 },
        new UnitData{ Id = 25, Name = "gal(uk)/100mi", Category = 2 },
        new UnitData{ Id = 26, Name = "km/gal(uk)", Category = 2 },
        new UnitData{ Id = 27, Name = "kWh/km", Category = 2 },
        new UnitData{ Id = 28, Name = "kWh/100km", Category = 2 },
        new UnitData{ Id = 29, Name = "kWh/mi", Category = 2 },
        new UnitData{ Id = 30, Name = "kWh/100mi", Category = 2 },
        new UnitData{ Id = 31, Name = "km/kWh", Category = 2 },
        new UnitData{ Id = 32, Name = "mi/kWh", Category = 2 },
        new UnitData{ Id = 33, Name = "kg/km", Category = 2 },
        new UnitData{ Id = 34, Name = "kg/100km", Category = 2 },
        new UnitData{ Id = 35, Name = "kg/mi", Category = 2 },
        new UnitData{ Id = 36, Name = "kg/100mi", Category = 2 },
        new UnitData{ Id = 37, Name = "km/kg", Category = 2 },
        new UnitData{ Id = 38, Name = "mi/kg", Category = 2 },
        new UnitData{ Id = 39, Name = "gge/km", Category = 2 },
        new UnitData{ Id = 40, Name = "gge/100km", Category = 2 },
        new UnitData{ Id = 41, Name = "gge/mi", Category = 2 },
        new UnitData{ Id = 42, Name = "gge/100mi", Category = 2 },
        new UnitData{ Id = 43, Name = "km/gge", Category = 2 },
        new UnitData{ Id = 44, Name = "mi/gge", Category = 2 },
        new UnitData{ Id = 45, Name = "l/h", Category = 2 },
        new UnitData{ Id = 46, Name = "h/l", Category = 2 },
        new UnitData{ Id = 47, Name = "gal(us)/h", Category = 2 },
        new UnitData{ Id = 48, Name = "h/gal(us)", Category = 2 },
        new UnitData{ Id = 49, Name = "gal(uk)/h", Category = 2 },
        new UnitData{ Id = 50, Name = "h/gal(uk)", Category = 2 },
        new UnitData{ Id = 51, Name = "kWh/h", Category = 2 },
        new UnitData{ Id = 52, Name = "h/kWh", Category = 2 },
        new UnitData{ Id = 53, Name = "kg/h", Category = 2 },
        new UnitData{ Id = 54, Name = "h/kg", Category = 2 },
        new UnitData{ Id = 55, Name = "gge/h", Category = 2 },
        new UnitData{ Id = 56, Name = "h/gge", Category = 2 }
      };
